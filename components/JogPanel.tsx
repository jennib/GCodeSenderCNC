                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <div className='bg-background p-3 rounded-md'>
                        ...
                        <div className='grid grid-cols-2 gap-2 text-sm'>
                            <button onClick={() => onProbe('X')} disabled={isControlDisabled} className='p-2 bg-primary text-white font-semibold rounded hover:bg-primary-focus disabled:opacity-50'>Probe X</button>
                            <button onClick={() => onProbe('Y')} disabled={isControlDisabled} className='p-2 bg-primary text-white font-semibold rounded hover:bg-primary-focus disabled:opacity-50'>Probe Y</button>
                            <button onClick={() => onProbe('Z')} disabled={isControlDisabled} className='p-2 bg-primary text-white font-semibold rounded hover:bg-primary-focus disabled:opacity-50 flex items-center justify-center gap-1'><Probe className='w-4 h-4' /> Probe Z</button>
                            <button onClick={() => onProbe('XY')} disabled={isControlDisabled} className='p-2 bg-primary text-white font-semibold rounded hover:bg-primary-focus disabled:opacity-50'>Probe XY</button>
                        </div>
                    </div>
                    <div className='bg-background p-3 rounded-md'>
