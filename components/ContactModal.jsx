            ...
            >
                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6 space-y-4">
                        {error && <div className="bg-accent-red/20 text-accent-red p-3 rounded-md text-sm font-semibold">{error}</div>}
                        <div>
                            <label htmlFor="contact-name" className="block text-sm font-medium text-text-secondary mb-1">Your Name</label>
                            <input
                                id="contact-name"
                                type="text"
                                value={name}
                        ...
                        <div>
                            <label htmlFor="contact-email" className="block text-sm font-medium text-text-secondary mb-1">Your Email</label>
                            <input
                                id="contact-email"
                                type="email"
                                value={email}
                        ...
                        <p className="text-xs text-text-secondary">This will open your default email client to send the message.</p>
                    </div>
